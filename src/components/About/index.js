...
function About() {
  return (
    ...
    <h3 className="damionFont"><span className="aboutKnow damionFont">KNOW</span> THE DEVELOPER</h3>
        ...
        <div class="aboutText">Coming from a human services based background, I believe community and connection are the keys to success.   </div>
        <div class="aboutText">I look forward to collaborating with you to create the platform to tell your story.</div>
      </div>
