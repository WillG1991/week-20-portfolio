...
const images = [
  ...
  { src: eventSite, alt: "Event Site", text: "EVENT SITE", header: "EVENT PLANNING SITE", description: "A consumer event planning site using React.js. The site features an intuitive user interface and incorporates an EmailJS contact form. Additionally, the site has photo gallery with a lightbox, showcasing images.(Desktop/Mobile only)", link: "https://polishedeventsco.com/" },
];
